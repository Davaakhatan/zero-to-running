...
# Deploy Zero-to-Running Developer Environment to GCP GKE
...
echo "🚀 Deploying Zero-to-Running Developer Environment to GCP GKE"
...
if ! kubectl cluster-info &> /dev/null; then
    ...
    echo "💡 Run: gcloud container clusters get-credentials <cluster-name> --zone <zone>"
    exit 1
fi
...
# Apply GCP-specific storage class
echo "📝 Applying GCP storage class..."
